...
export default async function Page() {
  ...
  return (
    <div>
      <h1 style={{ fontSize:28, fontWeight:300, marginBottom:'var(--s8)' }}>Project Management</h1>
      <p style={{ color:'var(--white-muted)', marginBottom:'var(--s40)' }}>Track active projects, assignees, and deliverables.</p>
