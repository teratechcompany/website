...
export default async function Page() {
  ...
  return (
    <div>
      <h1 style={{ fontSize:28, fontWeight:300, marginBottom:'var(--s8)' }}>Exit Interviews</h1>
      <p style={{ color:'var(--white-muted)', marginBottom:'var(--s40)' }}>Structured exit surveys for programme leavers.</p>
