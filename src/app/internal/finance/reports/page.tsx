...
export default async function Page() {
  ...
  return (
    <div>
      <h1 style={{ fontSize:28, fontWeight:300, marginBottom:'var(--s8)' }}>Finance Reports</h1>
      <p style={{ color:'var(--white-muted)', marginBottom:'var(--s40)' }}>Monthly financial summaries and expense breakdowns.</p>
